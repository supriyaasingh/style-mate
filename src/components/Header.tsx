...
+import { User, LogOut, Sparkles, Users, BarChart3 } from 'lucide-react';
...
+                <Link to="/bmi-calculator" className="text-gray-700 hover:text-rose-500 transition-colors">
+                  Health & BMI
+                </Link>
                 <Link to="/outfits" className="text-gray-700 hover:text-rose-500 transition-colors">
                   Outfits
                 </Link>
+                <Link to="/social" className="text-gray-700 hover:text-rose-500 transition-colors flex items-center space-x-1">
+                  <Users className="h-4 w-4" />
+                  <span>Community</span>
+                </Link>
+                {isAdmin && (
+                  <Link to="/admin" className="text-gray-700 hover:text-rose-500 transition-colors flex items-center space-x-1">
